...
public class AdminRestControllerTest extends AbstractRestControllerTest {
    ...
    public void testGet() throws Exception {
        mockMvc.perform(get(REST_URL + ADMIN_ID).secure(true)
    ...
    public void testGetNotFound() throws Exception {
        mockMvc.perform(get(REST_URL + 1).secure(true)
                .header(HttpHeaders.AUTHORIZATION, token(ADMIN)))
    ...
    public void testGetByEmail() throws Exception {
        mockMvc.perform(get(REST_URL + "by?email=" + ADMIN.getEmail()).secure(true)
                .header(HttpHeaders.AUTHORIZATION, token(ADMIN)))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(MATCHER.contentMatcher(ADMIN));
    ...
    public void testDelete() throws Exception {
        mockMvc.perform(delete(REST_URL + USER_ID).secure(true)
                .header(HttpHeaders.AUTHORIZATION, token(ADMIN)))
                .andDo(print())
                .andExpect(status().isOk());
    ...
    public void testDeleteNotFound() throws Exception {
        mockMvc.perform(delete(REST_URL + 1).secure(true)
                .header(HttpHeaders.AUTHORIZATION, token(ADMIN)))
                .andExpect(status().isNotFound())
                .andDo(print());
    }
    ...
    public void testUpdate() throws Exception {
        ...
        mockMvc.perform(put(REST_URL + USER_ID).secure(true)
