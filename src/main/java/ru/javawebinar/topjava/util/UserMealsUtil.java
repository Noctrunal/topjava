...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExceed> getUserMealsWithExceeds(List<UserMeal> mealList, int caloriesPerDay) {
        return mealList.stream()
                .map(um -> new UserMealWithExceed(um.getId() ,um.getDateTime(), um.getDescription(), um.getCalories(), mealList.stream()
                .collect(Collectors.groupingBy(uml -> uml.getDateTime().toLocalDate(), Collectors.summingInt(UserMeal::getCalories)))
